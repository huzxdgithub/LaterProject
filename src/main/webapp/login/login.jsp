      ...
      function  validateCode(a,b,c){
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${pageContext.request.contextPath}/Admin/validationCode?time="+new Date())
            });
            $("#loginButtonId").click(function () {
               var username= $("#form-username").val();
               var password= $("#form-password").val();
               var code= $("#form-code").val();
               var s= validateCode(username,password,code);
               if(s!=false){
                $.ajax({
                    type:"post",
                    ...
                    success:function (data) {
                        if(data=="正确"){
                            location.href="${pageContext.request.contextPath}/backstage/homepage.jsp"
                        }else{
                            $("#error").text(data);
                        }
                    }
                        ...
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="adminName" placeholder="请输入用户名..."
                                       class="form-username form-control" name="adminName" id="form-username">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/Admin/validationCode">
